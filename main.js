...
/* let modalBtns = [...document.querySelectorAll(".sastojci2")];
	...
	/* blk2.innerHTML=json[0]; */  /* ne radi, mislim da neke zagrade nisu dobre u json-u*/
	blk2.innerHTML=json.name;		/* zato sam ovako stavio*/
	
}

	function KreirajElemente() {
	var mojdiv= document.getElementById("pismeni2");
	for(var i=0; i< /* json[1].length *//*isto ne radi*/ json.data.length; i++)
	{
		var paragraf= document.createElement("p");
		/* paragraf.innerHTML= json[1][i]; */ /* isto*/
		paragraf.innerHTML= json.data[i];
